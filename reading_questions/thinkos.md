...
*Theoretically, up to about 4 billion characters. (2^32)*

3) What is the difference between "memory" and "storage" as defined in Think OS?
*"Memory" refers to volatile RAM, while "storage" refers to persistent disks like HDDs and SSDs.*

4) What is the difference between a GiB and a GB?  What is the percentage difference in their sizes?
*A gibibyte is base 2 (2^32 bytes), while a gigabyte is base 10 (10^9 bytes). A gibibyte is about 7% larger.*

5) How does the virtual memory system help isolate processes from each other?
*By having the abstraction of virtual memory between processes and hardware, the operating system can prevent multiple processes from accessing the same physical memory (the MMU prevents virtual addresses from being mapped to the same space).*
...
*Context switching allows the operating system to suspend and resume processes while storing state (multitasking)*
...
*There's 0x20 (32) bytes between them.*
