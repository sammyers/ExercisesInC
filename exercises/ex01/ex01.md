...
*The compiler wasn't a fan of declaring and assigning a variable on the same line.*
...
*Note: the compiler is not a fan of x not being a string.*
...
*X pretty much disappears with optimization on. Since the value isn't used for anything other than deriving y, the compiler optimizes out that assignment.*

What conclusions can you draw about how optimization works?

*Basically, the above; it looks like optimization gets rid of "intermediate" parts of the program where possible.*
